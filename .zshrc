...
# Path to your oh-my-zsh installation.
  export ZSH=/home/optimans/.oh-my-zsh
...
alias play="mplayer *.mp3 -quiet -shuffle"
alias playy="mplayer */*.mp3 -quiet -shuffle"
...
alias astyle="astyle --style=google"
alias update="sudo apt-get update && sudo apt-get upgrade"
alias testnet="ping -c 3 www.google.com"
alias play="mplayer *.mp3"
alias lynx="lynx www.google.com --accept_all_cookies"
alias sshcloud="ssh optimans@64.137.206.167"
alias pingcloud="ping 64.137.206.167"
alias newnote='if [ -f `date +%d-%m-%y` ]; then     echo "A note exists yet"; else     touch `date +%d-%m-%y`; fi'
...
alias pandoc="pandoc --css ~/sample/notes.css" --mathjax -s --self-contained

export PATH=/home/optimans/anaconda2/bin:$PATH
